...
const Item = ({libro}) => {
    ...
    return (
        <div>
            <div className="card flex centro" style={{width: 15 + 'rem' , height: 27 +'rem' , padding: '0.7rem'}} >
                ...
                <div className="card-body" style={{height: 15 +'rem' , boxShadow: '0.5rem'}}>
                    <h5 className="card-title text-center" style={{width: '10rem' , height: '6rem'}}> {libro.titulo}</h5>
                    <p className="card-text text-center">{libro.autor}</p>
                    <p className="card-text text-center">$ {libro.precio}</p>
                <div>
                    </div>
                        <Link to={`/detalle/${libro.id}`}>
                            <button type="button" className="btn btn-outline-dark justify-center" >
                                Ver detalle
                            </button>
                        </Link>
                    </div>
